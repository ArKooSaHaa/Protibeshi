...
export const ServicesPage = () => {
  ...
  const handleReport = (service: ServiceItem) => {
    window.alert(`Service report submitted for ${service.providerName}. Our team will review this.`);
  };
  ...
  return (
    <div className={styles.page} ref={containerRef}>
      ...
      <div className={styles.mobileTopBar}>
        ...
        <span className={styles.resultCount}>{filteredServices.length} services found</span>
      </div>
