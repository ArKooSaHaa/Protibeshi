// src/features/services/components/ServicesFilters.tsx 
import { motion } from 'framer-motion'; 
import { ChevronDown, SlidersHorizontal } from 'lucide-react'; 
import { availabilityOptions, serviceCategories, sortOptions } from 
'../mock/servicesData'; 
...
export const ServicesFilters = ({ filters, onFilterChange }: 
ServicesFiltersProps) => { 
 const updateValue = <K extends keyof ServiceFilterState>(key: K, 
...
=> { 
 ...
 const toggleAvailability = (value: (typeof 
   ...
   > 
     ...
     <div className={styles.group}> 
       ...
       <input 
         ...
         onChange={(event) => updateValue('distance', 
     ...
     <div className={styles.group}> 
       ...
       <div className={styles.priceRow}> 
         <input 
           ...
           onChange={(event) => updateValue('minPrice', 
Number(event.target.value) || 0)} 
         ...
         <input 
           ...
           onChange={(event) => updateValue('maxPrice', 
Number(event.target.value) || 0)} 
           placeholder="Max" 
           className={styles.input} 
         /> 
     ...
     <div className={styles.groupInline}> 
       <label className={styles.switchLabel}> 
         <input 
           ...
           onChange={() => updateValue('verifiedOnly', 
     ...
     <div className={styles.groupInline}> 
       <label className={styles.switchLabel}> 
         <input 
           ...
           onChange={() => updateValue('minRating', filters.minRating 
>= 4 ? 0 : 4)} 
         /> 
         <span>4★ & above</span> 
       </label> 
     ...
     <div className={styles.group}> 
       ...
       <select 
         ...
         onChange={(event) => updateValue('sortBy', event.target.value 
as ServiceFilterState['sortBy'])} 
       > 
