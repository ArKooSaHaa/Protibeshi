...
import { availabilityOptions, serviceCategories } from '../mock/servicesData';
...
export const OfferServiceModal = ({ isOpen, onClose, onSubmit }: OfferServiceModalProps) => {
  ...
  const updateField = <K extends keyof OfferServiceFormValues>(key: K, value: OfferServiceFormValues[K]) => {
        ...
        >
          ...
          >
            ...
            <form className={styles.form} onSubmit={handleSubmit}>
              <div className={styles.grid}>
                <label className={styles.field}>
                  ...
                  <input
                    ...
                    onChange={(event) => updateField('serviceTitle', event.target.value)}
                ...
                <label className={styles.field}>
                  ...
                  <select
                    value={form.category}
                    onChange={(event) => updateField('category', event.target.value as OfferServiceFormValues['category'])}
                  >
                ...
                <label className={styles.field}>
                  ...
                  <select
                    ...
                    onChange={(event) => updateField('priceUnit', event.target.value as OfferServiceFormValues['priceUnit'])}
                  >
                ...
                <label className={styles.field}>
                  ...
                  <select
                    ...
                    onChange={(event) => updateField('availability', event.target.value as OfferServiceFormValues['availability'])}
                  >
                ...
                <label className={styles.field}>
                  ...
                  <input
                    ...
                    onChange={(event) => updateField('serviceRadius', Number(event.target.value))}
                  />
                </label>
                ...
                <label className={styles.field}>
                  ...
                  <input
                    ...
                    onChange={(event) => updateField('portfolioImages', event.target.value)}
                  />
                </label>
              ...
              {submitted && !isValid && <p className={styles.errorText}>Please complete required fields.</p>}
