...
import { Bookmark, BookmarkCheck, CircleAlert, MessageSquareText, ShieldCheck, Star } from 'lucide-react';
    ...
    >
      <div className={styles.topRow}>
        <div className={styles.profileWrap}>
          <img className={styles.avatar} src={service.avatar} alt={service.providerName} />
          <div>
      ...
      <div className={styles.tagRow}>
        ...
        <span className={styles.availabilityTag}>{service.availability}</span>
      </div>
