...
import { Bookmark, BookmarkCheck, CircleAlert, MessageSquareText, 
...
=> onReport(service)}> 
       ...
       <span 
         ...
         title={`This service appears because it's ${service.distance}m 
from your location and within your active filters.`} 
       > 
