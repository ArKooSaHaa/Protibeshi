//src/features/feed/components/FeedSidebarFilters.jsx
                ...
                <div className={styles.section}>
                    ...
                    <div className={styles.timeFilters}>
                        {mockTimeFilters.map((filter) => (
                            <motion.button
                                key={filter.id}
                                className={`${styles.timeButton} ${timeFilter ===
                                    filter.id ? styles.timeButtonActive : ''}`}
                    ...
                    <div className={styles.categories}>
                        {categories.map((category) => {
                            ...
                            return (
                                <motion.label
                                    key={category.id}
                                    className={`${styles.category} ${isSelected ?
                                ...
                                >
                                    ...
                                    <span
                                        className={styles.categoryLabel}>{category.label}</span>
                                </motion.label>
                            );
                        })}
                    </div>
