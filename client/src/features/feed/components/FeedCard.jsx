    ...
    return (
        ...
        >{/* Header */}
            <div className={styles.header}>
                <div className={styles.author}>
                    ...
                    <div className={styles.authorInfo}>
                        <div className={styles.authorNameRow}>
                            <span
                                className={styles.authorName}>{post.author.name}</span>
                            {post.author.isOfficial && (
                ...
                <div className={styles.meta}>
                    <span className={styles.metaItem}>
                        <MapPin size={14} />{post.distance} away
                    </span>
            ...
            <div className={styles.content}>
                <h3 className={`${styles.title} ${isEmergency ?
                    styles.titleEmergency : ''}`}>
                ...
                {/* Tags */}
                <div className={styles.tags}>{post.tags.map((tag, i) => (
                    <span
                        key={i}
                        className={`${styles.tag} ${isEmergency ?
                            styles.tagEmergency : ''}`}
                    >
                        {tag}
                    </span>
...
${styles.menuItemDanger}`}
            ...
            {showReport && (
                <div className={styles.reportOverlay} onClick={() =>
                    setShowReport(false)}>
                    <div className={styles.reportModal} onClick={(event) =>
                        ...
                        <form className={styles.reportForm}
                            ...
                            <label className={styles.reportField}>
                                ...
                                >
                                    ...
                                    <option value="violence">Violence or dangerous
                                        behavior</option>
