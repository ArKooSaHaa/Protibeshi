export const mockPosts = [
  {
    ...
    content: 'Emergency services have been notified. Please exit the building calmly using the nearest stairwell. Assembly point at the main gate.',
  ...
  },
  {
    ...
    content: 'Have a full set of CBSE class 8 books in good condition. Happy to give away to any student in the neighborhood.',
    tags: ['Education', 'Free'],
    likes: 24,
    comments: 8,
  ...
  },
  {
    ...
    content: 'Experienced plumber available for all types of repairs. Leakage, pipe fitting, bathroom fittings. Reasonable rates.',
  ...
  },
  {
    ...
    content: 'Wooden dining table in excellent condition. 6 seater with chairs. Price: ₹8,000 (negotiable). Pickup from Block B.',
  ...
  },
  {
    ...
    content: 'Join us for the monthly residents meeting. Agenda: Security updates, maintenance fund, upcoming events.',
...
export const mockCategories = [
  ...
  { id: 'marketplace', label: 'Marketplace', icon: 'ShoppingBag', color: 'orange' },
];
...
export const mockNavigation = [
  ...
  { id: 'marketplace', label: 'Marketplace', icon: 'ShoppingBag', active: false },
  { id: 'rent', label: 'Rent', icon: 'Building', active: false },
  { id: 'services', label: 'Services', icon: 'Wrench', active: false },
  { id: 'complaints', label: 'Complaints', icon: 'AlertCircle', active: false },
...
export const mockAIAssistant = {
  status: 'Ready',
  message: 'Hi! I am your Protibeshi AI. Ask me anything about your neighborhood — routes, safety, services, or events.',
};
