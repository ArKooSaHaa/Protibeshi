...
export const FeedPage = () => {
  ...
  return (
    ...
    >
      {/* Left Column - Filters */}
      <motion.aside className={styles.leftColumn} variants={itemVariants}>
        <FeedSidebarFilters />
      </motion.aside>

      {/* Center Column - Feed */}
      <motion.main className={styles.centerColumn} variants={itemVariants}>
      ...
      <motion.aside className={styles.rightColumn} variants={itemVariants}>
        <NeighborhoodMood />
        <UpcomingEventsPanel />
      </motion.aside>
    </motion.div>
