...
interface ComplaintFormProps {
  ...
  onChange: <K extends keyof ComplaintFormState>(key: K, value: ComplaintFormState[K]) => void;
  onSubmit: () => void;
}

export const ComplaintForm = ({ formState, formErrors, onChange, onSubmit }: ComplaintFormProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className={styles.fieldGroup}>
        <label className={styles.label}>
          ...
          <input
            ...
            maxLength={complaintFormLimits.title}
          />
        </label>
        <div className={styles.helperRow}>
          {formErrors.title ? <span className={styles.error}>{formErrors.title}</span> : <span />}
      ...
      <div className={styles.fieldGroup}>
        <label className={styles.label}>
          ...
          <select
            ...
            onChange={(event) =>
              onChange('category', event.target.value as ComplaintFormState['category'])
            }
          >
      ...
      <div className={styles.fieldGroup}>
        ...
        <div className={styles.helperRow}>
          {formErrors.description ? <span className={styles.error}>{formErrors.description}</span> : <span />}
          <span className={styles.count}>
      ...
      <div className={styles.gridRow}>
        ...
        <label className={styles.label}>
          ...
          <select
            ...
            onChange={(event) =>
              onChange('priority', event.target.value as ComplaintFormState['priority'])
            }
          >
      ...
      {(formErrors.location || formErrors.priority) && (
        <div className={styles.errorRow}>
          ...
          {formErrors.priority && <span className={styles.error}>{formErrors.priority}</span>}
        </div>
      )}
      ...
      <div className={styles.gridRow}>
        <label className={styles.label}>
          ...
          <select
            ...
            onChange={(event) =>
              onChange('visibility', event.target.value as ComplaintFormState['visibility'])
            }
          >
      ...
      <div className={styles.noticeBox}>
        <AlertCircle size={16} />
        <p>
          All complaints are reviewed by community moderators. Please provide accurate information to help
          with resolution.
        </p>
      </div>
