  ...
  return (
    <motion.article
      className={`${styles.card} ${
        complaint.priority === "Urgent" ? styles.urgent : ""
      }`}
...
${styles[`priority${complaint.priority}`]}`}
      ...
      <div className={styles.extraRow}>
        ...
        {complaint.verified && (
          <span className={styles.verified}>Verified resident</span>
        )}
        {complaint.visibility === "Only admins" && (
          <span className={styles.visibility}>Admins only</span>
        )}{" "}
        {complaint.resolutionSummary && (
          <span className={styles.resolved}>Resolution recorded</span>
        )}
      </div>
