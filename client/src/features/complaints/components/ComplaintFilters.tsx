...
export const ComplaintFilters = ({
  ...
  const toggleValue = <T extends string>(
    key: keyof ComplaintFilterState,
    value: T,
  ) => {
    ...
    >
      ...
      <div className={styles.group}>
        ...
        <input
          ...
          onChange={(event) =>
            onChange({ ...filters, distance: Number(event.target.value) })
          }
        />
          ...
          onChange={(event) =>
            onChange({
              ...
              timeRange: event.target
                .value as ComplaintFilterState["timeRange"],
            })
          }
        >
      ...
      <label className={styles.toggle}>
        <input
          ...
          onChange={() =>
            onChange({ ...filters, myComplaints: !filters.myComplaints })
          }
        />
        My complaints only
      </label>
