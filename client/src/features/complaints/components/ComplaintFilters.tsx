...
export const ComplaintFilters = ({ filters, onChange }: ComplaintFiltersProps) => {
  const toggleValue = <T extends string>(key: keyof ComplaintFilterState, value: T) => {
    ...
    >
      ...
      <div className={styles.group}>
        ...
        <select
          ...
          onChange={(event) => onChange({ ...filters, timeRange: event.target.value as ComplaintFilterState['timeRange'] })}
        >
      ...
      <label className={styles.toggle}>
        <input
          ...
          onChange={() => onChange({ ...filters, myComplaints: !filters.myComplaints })}
        />
        My complaints only
      </label>
    </motion.section>
