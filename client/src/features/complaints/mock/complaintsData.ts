...
export const complaintsData: ComplaintItem[] = [
  ...
  },
  {
    ...
    category: 'Noise',
    description:
      'Construction work continues past 11 PM creating noise disturbances. Please enforce the designated quiet hours.',
    priority: 'Medium',
    status: 'Under Review',
  ...
  {
    id: 'CMP-2026-0017',
    title: 'Suspicious activity reported near grocery lane',
    category: 'Safety',
    description:
    ...
    priority: 'High',
    status: 'In Progress',
    createdAt: '2026-02-17T23:05:00.000Z',
    distance: 670,
    upvotes: 21,
    comments: 8,
    reportedBy: 'Anonymous',
    ...
    updates: [
      { stage: 'Reported', date: '2026-02-17' },
