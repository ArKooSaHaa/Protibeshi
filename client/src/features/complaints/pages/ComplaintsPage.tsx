...
export const ComplaintsPage = () => {
  ...
  const complaintsMemo = useMemo(() => filteredComplaints, [filteredComplaints]);

  return (
    <div className={styles.page}>
      <div className={styles.grid}>
        <div className={styles.rightColumn}>
          <ComplaintsHeader locationLabel={locationLabel} onSubmitClick={() => setIsFormOpen(true)} />

          <p className={styles.recordsCount}>
            {complaintsMemo.length} {complaintsMemo.length === 1 ? 'record' : 'records'}
          </p>
