...
export const MarketplacePage = () => {
  ...
  const filterByBadge = (badgeType) => {
    if (badgeType === 'Verified') {
      return listings.filter((item) => item.badge === 'Verified');
    }
    return listings;
  };
  ...
  const getFilteredListings = () => {
    ...
    if (selectedFilter === 'verified') {
      ...
      filtered = filtered.filter((item) => item.badge === 'Hot' || item.price.includes('BDT'));
    }
      ...
      <div className={styles.contentGrid}>
        <aside className={styles.filtersPanel}>
          ...
          <div className={styles.priceGrid}>
            ...
            <button type="button" className={styles.priceApply}>Apply</button>
          </div>
