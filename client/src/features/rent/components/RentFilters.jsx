...
const RentFilters = ({ filters, onFilterChange }) => {
  ...
  const toggleQuickFilter = (key) => {
    ...
    if (key === 'furnished') {
      const updated = handleQuickMultiSelect(filters.furnishing, 'fully-furnished');
    ...
    if (key === 'family-friendly') {
      const updated = handleQuickMultiSelect(filters.bedrooms, ['2bhk', '3bhk']);
    ...
    >
      <div className={styles.quickFilters}>
        ...
        <div className={styles.quickFiltersGrid}>
          ...
          <motion.button
            type="button"
            className={`${styles.quickFilterChip} ${
              filters.furnishing.includes('fully-furnished') ? styles.quickFilterChipActive : ''
            }`}
          ...
          <motion.button
            type="button"
            className={`${styles.quickFilterChip} ${
              filters.bedrooms.includes('2bhk') || filters.bedrooms.includes('3bhk')
      ...
      <div className={styles.filterSection}>
        ...
        {expandedSection === 'type' && (
          <motion.div
            ...
            transition={{ duration: 0.2 }}
          >
            {['apartment', 'sublet', 'room', 'studio', 'shared'].map((type) => (
              <label key={type} className={styles.checkbox}>
                <input
                  type="checkbox"
                  checked={filters.propertyTypes.includes(type)}
                  onChange={() => handleMultiSelect('propertyTypes', type)}
                />
            ...
            {[
              ...
              <label key={value} className={styles.checkbox}>
                <input
                  ...
                  onChange={() => handleMultiSelect('furnishing', value)}
                />
                <span>{label}</span>
              </label>
            ))}
            ...
            {[
              ...
              <label key={value} className={styles.checkbox}>
                <input
                  ...
                  onChange={() => handleMultiSelect('availability', value)}
                />
                <span>{label}</span>
              </label>
            ))}
      ...
      <div className={styles.filterSection}>
        <label className={styles.toggleLabel}>
          ...
          />
          <span className={styles.toggleText}>Verified landlords only</span>
        </label>
      </div>
