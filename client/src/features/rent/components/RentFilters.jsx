    ...
    >
      <div className={styles.quickFilters}>
        ...
        <div className={styles.quickFiltersGrid}>
          ...
          <motion.button
            type="button"
            className={`${styles.quickFilterChip} ${filters.furnishing.includes('fully-furnished') ?
          ...
          <motion.button
            type="button"
            className={`${styles.quickFilterChip} ${filters.bedrooms.includes('2bhk') ||
      ...
      <div className={styles.filtersBody}>
        ...
        <div className={styles.filterSection}>
          ...
          >
            ...
            <motion.div
              animate={{
                rotate: expandedSection === 'furnish' ? 180 : 0
              }}
              transition={{ duration: 0.2 }}
            >
              <ChevronDown size={18} />
