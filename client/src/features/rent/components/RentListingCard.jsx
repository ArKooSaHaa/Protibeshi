...
import { MapPin, Bed, Bath, Ruler, Heart, MessageCircle, Shield, Eye, Clock } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className={styles.imageContainer}>
        ...
        {/* Badge */}
        {badgeInfo && (
          <div className={`${styles.badgeTop} ${styles[`badge${badgeInfo.color}`]}`}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.priceSection}>
          <h3 className={styles.price}>₹{listing.price.toLocaleString()}</h3>
          <p className={styles.deposit}>+ ₹{listing.deposit.toLocaleString()} deposit</p>
        </div>
        ...
        <div className={styles.availabilityTag}>
          ...
          {listing.availability === 'dated' && (
            <>
              <span className={styles.tag}>Available from {listing.availabilityDate}</span>
            </>
          )}
        </div>
        ...
        <div className={styles.trustSignals}>
          {listing.verified && (
            <motion.div className={styles.trustItem} whileHover={{ scale: 1.05 }}>
              <Shield size={14} />
          ...
          <motion.div className={styles.trustItem} whileHover={{ scale: 1.05 }}>
            <Clock size={14} />
            <span>{listing.listedDays === 0 ? 'Today' : listing.listedDays + ' days ago'}</span>
          </motion.div>
        </div>
