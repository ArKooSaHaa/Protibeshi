/**
 * Relief Feature — Type Definitions
 * All types isolated to this feature.
 */
...
export const reliefUrgencyLevels = ['Normal', 'Important', 'Urgent', 'Critical'] as const;
...
export const reliefContactPreferences = ['In-app message', 'Phone'] as const;

export const reliefTimeSensitivities = ['Immediate', 'Within 24 hours', 'Flexible'] as const;

export const reliefTimeRanges = ['Today', 'This week', 'This month', 'All'] as const;
...
export type ReliefVisibility = (typeof reliefVisibilityOptions)[number];
export type ReliefContactPreference = (typeof reliefContactPreferences)[number];
export type ReliefTimeSensitivity = (typeof reliefTimeSensitivities)[number];
