...
interface HelpOfferFormProps {
  ...
  onChange: <K extends keyof HelpOfferFormState>(key: K, value: HelpOfferFormState[K]) => void;
  onSubmit: () => void;
}
...
export const HelpOfferForm = ({
  ...
  return (
    <div className={styles.form}>
      ...
      {/* Help Type */}
      <div className={styles.field}>
        <label className={styles.label}>Type of help you can offer *</label>
      ...
      <div className={styles.field}>
        ...
        <textarea
          ...
          placeholder="Describe what help you can provide, any limitations, and how people should contact you."
      ...
      <div className={styles.field}>
        ...
        <div className={styles.chipGroup}>
          {reliefAvailabilities.map((a) => (
            <button
              key={a}
              type="button"
              className={`${styles.chip} ${form.availability === a ? styles.selected : ''}`}
        ...
        {errors.availability && <span className={styles.errorMsg}>{errors.availability}</span>}
      </div>
      ...
      <div className={styles.field}>
        ...
        <div className={styles.sliderRow}>
          <div className={styles.sliderLabel}>
            <span>Local</span>
            <span className={styles.sliderValue}>{form.serviceRadius} km</span>
            <span>10 km</span>
          </div>
          <input
            type="range"
