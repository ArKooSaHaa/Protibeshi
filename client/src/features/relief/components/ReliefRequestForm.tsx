...
interface ReliefRequestFormProps {
  ...
  onChange: <K extends keyof ReliefRequestFormState>(key: K, value: ReliefRequestFormState[K]) => void;
  onSubmit: () => void;
}
    ...
    <div className={styles.form}>
      <div className={styles.formHeader}>
        ...
        <p className={styles.formSubtitle}>
          Describe your situation clearly so neighbors can help effectively.
        </p>
      </div>
      ...
      <div className={styles.field}>
        ...
        <div className={styles.chipGroup}>
          {reliefHelpTypes.map((t) => (
            <button
              key={t}
              type="button"
              className={`${styles.chip} ${form.helpType === t ? styles.selected : ''}`}
        ...
        {errors.helpType && <span className={styles.errorMsg}>{errors.helpType}</span>}
      </div>
      ...
      <div className={styles.field}>
        ...
        <textarea
          ...
          placeholder="Describe your situation in detail. Be specific about what you need and why."
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          ...
          <select
            ...
            onChange={(e) => onChange('timeSensitivity', e.target.value as ReliefRequestFormState['timeSensitivity'])}
          >
        ...
        <div className={styles.field}>
          ...
          <select
            ...
            onChange={(e) => onChange('visibility', e.target.value as ReliefRequestFormState['visibility'])}
          >
        ...
        <div className={styles.chipGroup}>
          {reliefContactPreferences.map((c) => (
            <button
              key={c}
              type="button"
              className={`${styles.chip} ${form.contactPreference === c ? styles.selected : ''}`}
