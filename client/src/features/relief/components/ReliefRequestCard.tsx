    ...
    >
      ...
      <div className={styles.cardHeader}>
        <div className={styles.titleRow}>
          <div className={styles.badges}>
            ...
            <span className={`${styles.urgBadge} ${styles[urg.colorClass]}`}>
        ...
        <span className={`${styles.statusBadge} ${styles[stat.colorClass]}`}>
          {stat.label}
        </span>
      </div>
      ...
      <div className={styles.footer}>
        <div className={styles.poster}>
          ...
          <span>{request.anonymous ? 'Anonymous' : request.postedBy}</span>
        </div>
