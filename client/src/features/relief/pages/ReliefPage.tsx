...
import { ReliefDetailsDrawer } from '../components/ReliefDetailsDrawer';
import { ReliefFiltersDrawer } from '../components/ReliefFiltersDrawer';
...
export const ReliefPage = () => {
  ...
  const activeCount = filters.tab === 'requests' ? filteredRequests.length : filteredOffers.length;
