...
export const ServicePostsList = ({ posts, totalCount, isLoading, hasMore, onLoadMore, onDelete }: ServicePostsListProps) => {
  ...
  return (
    <>
        ...
        {posts.map((post, index) => (
          ...
          >
            ...
            <div className="mt-2 text-xs text-slate-500">
              ...
              <p>Price range: {post.priceRange}</p>
      ...
      <AlertDialog open={Boolean(selectedDeleteId)} onOpenChange={(open) => !open && setSelectedDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete this service post?</AlertDialogTitle>
